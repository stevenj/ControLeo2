...
const PROGMEM char FLD_PROMPT[] = ":";   ///< Prompt separator between input field label and left delimiter
const PROGMEM char FLD_DELIM_L[] = "[";  ///< Left delimiter for variable field input
const PROGMEM char FLD_DELIM_R[] = "]";  ///< Right delimiter for variable field input
const PROGMEM char MNU_DELIM_L[] = "<";  ///< Left delimiter for menu option label
const PROGMEM char MNU_DELIM_R[] = ">";  ///< Right delimiter for menu option label

const PROGMEM char INP_BOOL_T[] = "Y";   ///< Boolean input True display value. Length should be same as INP_BOOL_F
const PROGMEM char INP_BOOL_F[] = "N";   ///< Boolean input False display value. Length should be same as INP_BOOL_T

const char INP_NUMERIC_OFLOW = '#';  ///< Indicator for numeric overflow
const char LIST_SEPARATOR = '|';     ///< Separator character for list items
const PROGMEM char DECIMAL_POINT[] = ".";      ///< Decimal point character for floating point input
